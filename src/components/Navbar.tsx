    ...
    <>
      ...
      <motion.header
        ...
        animate={{
          ...
          backgroundColor: scrolled ? "var(--luxury-deep)" : "transparent",
        }}
        ...
        <div className="max-w-7xl mx-auto px-4 py-1.5 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group" aria-label="الصفحة الرئيسية">
            ...
            <div className="block">
              ...
              <span className="block text-gold-primary/60" style={{ fontSize: "0.6rem", letterSpacing: "0.25em" }}>
                KEIF AL-DIAFA
              </span>
            </div>
          </Link>
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`relative px-3 py-1.5 rounded-lg text-sm transition-all duration-200 min-h-[44px] flex items-center ${
                  isActive(link.href) ? "text-gold-primary" : "text-cream/70 hover:text-gold-primary"
                }`}
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden safe-bottom bottom-nav" style={{ paddingBottom: "max(12px, env(safe-area-inset-bottom))" }}>
        <div className="flex items-center justify-between px-4 pt-3 pb-1">
          <div className="flex gap-3">
            ...
            <a href="tel:+966508252134" className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs text-gold-primary min-h-[44px]" style={{ background: "rgba(184,134,11,0.08)", border: "1px solid rgba(184,134,11,0.2)" }}>
                ...
                <div className="space-y-1">
                  ...
                  {deferredPrompt && (
                    ...
                    >
                      ...
                      <p className="text-center text-gold-primary/50 text-[10px] mt-3">ثبّت التطبيق للوصول السريع وتجربة ضيافة متكاملة</p>
                    </motion.div>
                  )}
                </div>
              </div>
